# SUB-001 — Problem and solution statements

**Draft for Ramana's review.** Every factual claim below is verified — no
placeholder is left that could be read as a claim. Move to
`submission/PROBLEM_AND_SOLUTION.md` once approved.
