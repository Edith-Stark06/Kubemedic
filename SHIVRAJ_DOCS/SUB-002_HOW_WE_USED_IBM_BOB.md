# SUB-002 — How IBM Bob was utilised

**Draft for Ramana.** Sections 1-3 are true either way. **Section 4 has two
variants — pick one after `BOB-001` resolves and delete the other.**

Move to `submission/HOW_WE_USED_IBM_BOB.md` once settled.
